...
func main() {
	...
	flag.StringVar(&geoipDatabase, "geoipdb", "/opt/homebrew/Cellar/tor/0.4.8.13/share/tor/geoip", "path to correctly formatted geoip database mapping IPv4 address ranges to country codes")
	flag.StringVar(&geoip6Database, "geoip6db", "/opt/homebrew/Cellar/tor/0.4.8.13/share/tor/geoip6", "path to correctly formatted geoip database mapping IPv6 address ranges to country codes")
